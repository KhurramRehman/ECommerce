...
namespace ECommerce.Api.Orders.Providers
{
    public class OrdersProvider : IOrdersProvider
    {
        ...
        public async Task<(bool IsSuccess, IEnumerable<OrderViewModel>? Orders, string? ErrorMessage)> GetOrdersAsync(string customerId)
        {
            try
            {
                var orders = await dbContext.Orders
                    .Where(order => order.CustomerId == int.Parse(customerId))
